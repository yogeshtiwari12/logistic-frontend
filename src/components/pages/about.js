  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      <div className="container mx-auto py-10 px-4">
        {/* Welcome Section */}
        <section className="bg-white p-8 rounded-lg shadow-lg mb-8 transition transform hover:-translate-y-1 hover:shadow-xl">
        ...
        <section className="bg-white p-8 rounded-lg shadow-lg mb-8 transition transform hover:-translate-y-1 hover:shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:justify-between space-y-4 sm:space-y-0">
            <a
              href="/contact"
              className="inline-block px-6 py-2 text-white bg-blue-700 rounded-full hover:bg-blue-800 transition-colors"
            >
              Contact Us
            </a>
