  ...
  return (
    <div className="flex-shrink-0 w-full sm:w-72 md:w-80 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-5">
        ...
        <a
          href="/"
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-900 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
        >
          Read more
          <svg
